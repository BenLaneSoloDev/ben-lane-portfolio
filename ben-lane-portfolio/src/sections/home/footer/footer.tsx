...
export default function Footer() {
  return (
    <footer className={`${styles.footer} p-3 bg-def-l-green flex flex-row items-center justify-center gap-2`}>
      ...
      <a href="https://www.linkedin.com/in/benjamin-lane-b66524330/" target="_blank">
      ...
      <a href="https://github.com/BenLaneSoloDev" target="_blank">
      ...
      <a href="https://www.youtube.com/channel/UChL5Vii2c1F_NYnDZcpYctA" target="_blank">
